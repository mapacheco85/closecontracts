 ...
 * Page class
 */
class ContratoDelete extends Contrato
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ContratoDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("contratolist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("contratolist"); // Return to list
                return;
            }
        }
