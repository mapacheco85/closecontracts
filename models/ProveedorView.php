 ...
 * Page class
 */
class ProveedorView extends Proveedor
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ProveedorView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("CodProveedor") ?? Route("CodProveedor")) !== null) {
            $this->RecKey["CodProveedor"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("CodProveedor") ?? Route("CodProveedor")) !== null) {
                ...
                $returnUrl = "proveedorlist"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "proveedorlist"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "proveedorlist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
