...
/**
 * Table class for impresiones
 */
class Impresiones extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'impresiones';
        $this->TableName = 'impresiones';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`impresiones`";
        $this->Dbid = 'DB';
        ...
        // Propietario
        $this->Propietario = new DbField('impresiones', 'impresiones', 'x_Propietario', 'Propietario', '`Propietario`', '`Propietario`', 200, 255, -1, false, '`Propietario`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // NIT
        $this->NIT = new DbField('impresiones', 'impresiones', 'x_NIT', 'NIT', '`NIT`', '`NIT`', 200, 30, -1, false, '`NIT`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Cedula
        $this->Cedula = new DbField('impresiones', 'impresiones', 'x_Cedula', 'Cedula', '`Cedula`', '`Cedula`', 200, 30, -1, false, '`Cedula`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Direccion
        $this->Direccion = new DbField('impresiones', 'impresiones', 'x_Direccion', 'Direccion', '`Direccion`', '`Direccion`', 200, 255, -1, false, '`Direccion`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Fecha
        $this->Fecha = new DbField('impresiones', 'impresiones', 'x_Fecha', 'Fecha', '`Fecha`', CastDateFieldForLike("`Fecha`", 0, "DB"), 133, 10, 0, false, '`Fecha`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Lugar
        $this->Lugar = new DbField('impresiones', 'impresiones', 'x_Lugar', 'Lugar', '`Lugar`', '`Lugar`', 200, 20, -1, false, '`Lugar`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Vencimiento
        $this->Vencimiento = new DbField('impresiones', 'impresiones', 'x_Vencimiento', 'Vencimiento', '`Vencimiento`', CastDateFieldForLike("`Vencimiento`", 0, "DB"), 133, 10, 0, false, '`Vencimiento`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CodigoInterno
        $this->CodigoInterno = new DbField('impresiones', 'impresiones', 'x_CodigoInterno', 'CodigoInterno', '`CodigoInterno`', '`CodigoInterno`', 200, 20, -1, false, '`CodigoInterno`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MotivoBaja
        $this->MotivoBaja = new DbField('impresiones', 'impresiones', 'x_MotivoBaja', 'MotivoBaja', '`MotivoBaja`', '`MotivoBaja`', 200, 20, -1, false, '`MotivoBaja`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CodContrato
        $this->CodContrato = new DbField('impresiones', 'impresiones', 'x_CodContrato', 'CodContrato', '`CodContrato`', '`CodContrato`', 3, 11, -1, false, '`CodContrato`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // Sigla
        $this->Sigla = new DbField('impresiones', 'impresiones', 'x_Sigla', 'Sigla', '`Sigla`', '`Sigla`', 200, 20, -1, false, '`Sigla`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RazonSocial
        $this->RazonSocial = new DbField('impresiones', 'impresiones', 'x_RazonSocial', 'RazonSocial', '`RazonSocial`', '`RazonSocial`', 200, 255, -1, false, '`RazonSocial`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DiasVcto
        $this->DiasVcto = new DbField('impresiones', 'impresiones', 'x_DiasVcto', 'DiasVcto', '`DiasVcto`', '`DiasVcto`', 20, 21, -1, false, '`DiasVcto`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Observacion
        $this->Observacion = new DbField('impresiones', 'impresiones', 'x_Observacion', 'Observacion', '`Observacion`', '`Observacion`', 200, 22, -1, false, '`Observacion`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Monto
        $this->Monto = new DbField('impresiones', 'impresiones', 'x_Monto', 'Monto', '`Monto`', '`Monto`', 131, 7, -1, false, '`Monto`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`impresiones`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("impresioneslist");
    }
    ...
    {
        global $Language;
        if ($pageName == "impresionesview") {
            return $Language->phrase("View");
        } elseif ($pageName == "impresionesedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "impresionesadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            ...
            case Config("API_ADD_ACTION"):
                return "ImpresionesAdd";
            case Config("API_EDIT_ACTION"):
                return "ImpresionesEdit";
            case Config("API_DELETE_ACTION"):
                return "ImpresionesDelete";
            case Config("API_LIST_ACTION"):
                return "ImpresionesList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("impresionesview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("impresionesview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "impresionesadd?" . $this->getUrlParm($parm);
        } else {
            $url = "impresionesadd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("impresionesedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("impresionesadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("impresionesdelete", $this->getUrlParm());
    }
