 ...
 * Page class
 */
class ProveedorAdd extends Proveedor
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ProveedorAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "proveedorview") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->CodRegion->OldValue = $this->CodRegion->CurrentValue;
        $this->Vigente->CurrentValue = null;
        $this->Vigente->OldValue = $this->Vigente->CurrentValue;
        $this->MinimoValidado->CurrentValue = null;
        $this->MinimoValidado->OldValue = $this->MinimoValidado->CurrentValue;
        $this->tipo_transferencia->CurrentValue = null;
        $this->tipo_transferencia->OldValue = $this->tipo_transferencia->CurrentValue;
    }
    ...
    protected function newRow()
    {
        ...
        $row['Propietario'] = $this->Propietario->CurrentValue;
        $row['NIT'] = $this->NIT->CurrentValue;
        $row['Cedula'] = $this->Cedula->CurrentValue;
        $row['Telefono'] = $this->Telefono->CurrentValue;
        $row['Direccion'] = $this->Direccion->CurrentValue;
        $row['CodRegion'] = $this->CodRegion->CurrentValue;
        $row['Vigente'] = $this->Vigente->CurrentValue;
        $row['MinimoValidado'] = $this->MinimoValidado->CurrentValue;
    ...
    protected function addRow($rsold = null)
    {
        ...
        // CodRegion
        $this->CodRegion->setDbValueDef($rsnew, $this->CodRegion->CurrentValue, 0, false);
        ...
        $this->Vigente->setDbValueDef($rsnew, $tmpBool, 0, false);

        // MinimoValidado
        $this->MinimoValidado->setDbValueDef($rsnew, $this->MinimoValidado->CurrentValue, null, false);

        // tipo_transferencia
        $this->tipo_transferencia->setDbValueDef($rsnew, $this->tipo_transferencia->CurrentValue, null, false);
