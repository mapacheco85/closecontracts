 ...
 * Page class
 */
class DocumentoDelete extends Documento
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DocumentoDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("documentolist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("documentolist"); // Return to list
                return;
            }
        }
