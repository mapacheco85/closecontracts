...
class RegionSearch extends Region
{
    ...
    // Page object name
    public $PageObjName = "RegionSearch";
    ...
    protected function buildAdvancedSearch()
    {
        ...
        $this->buildSearchUrl($srchUrl, $this->Descripcion); // Descripcion
        if ($srchUrl != "") {
            $srchUrl .= "&";
        }
        $srchUrl .= "cmd=search";
    ...
    protected function loadSearchValues()
    {
        ...
        if ($this->Descripcion->AdvancedSearch->post()) {
            $hasValue = true;
        }
        return $hasValue;
    }
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->CodRegion->EditValue = HtmlEncode($this->CodRegion->AdvancedSearch->SearchValue);
    ...
    protected function validateSearch()
    {
        ...
        if (!CheckInteger($this->CodRegion->AdvancedSearch->SearchValue)) {
            $this->CodRegion->addErrorMessage($this->CodRegion->getErrorMessage(false));
        }
