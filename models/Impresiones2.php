...
/**
 * Table class for impresiones2
 */
class Impresiones2 extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'impresiones2';
        $this->TableName = 'impresiones2';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`impresiones2`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // CodContrato
        $this->CodContrato = new DbField('impresiones2', 'impresiones2', 'x_CodContrato', 'CodContrato', '`CodContrato`', '`CodContrato`', 3, 11, -1, false, '`CodContrato`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // Sigla
        $this->Sigla = new DbField('impresiones2', 'impresiones2', 'x_Sigla', 'Sigla', '`Sigla`', '`Sigla`', 200, 20, -1, false, '`Sigla`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Vencimiento
        $this->Vencimiento = new DbField('impresiones2', 'impresiones2', 'x_Vencimiento', 'Vencimiento', '`Vencimiento`', CastDateFieldForLike("`Vencimiento`", 0, "DB"), 133, 10, 0, false, '`Vencimiento`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CodigoInterno
        $this->CodigoInterno = new DbField('impresiones2', 'impresiones2', 'x_CodigoInterno', 'CodigoInterno', '`CodigoInterno`', '`CodigoInterno`', 200, 20, -1, false, '`CodigoInterno`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RazonSocial
        $this->RazonSocial = new DbField('impresiones2', 'impresiones2', 'x_RazonSocial', 'RazonSocial', '`RazonSocial`', '`RazonSocial`', 200, 255, -1, false, '`RazonSocial`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Propietario
        $this->Propietario = new DbField('impresiones2', 'impresiones2', 'x_Propietario', 'Propietario', '`Propietario`', '`Propietario`', 200, 255, -1, false, '`Propietario`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MotivoBaja
        $this->MotivoBaja = new DbField('impresiones2', 'impresiones2', 'x_MotivoBaja', 'MotivoBaja', '`MotivoBaja`', '`MotivoBaja`', 200, 20, -1, false, '`MotivoBaja`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DiasVcto
        $this->DiasVcto = new DbField('impresiones2', 'impresiones2', 'x_DiasVcto', 'DiasVcto', '`DiasVcto`', '`DiasVcto`', 20, 21, -1, false, '`DiasVcto`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Observacion
        $this->Observacion = new DbField('impresiones2', 'impresiones2', 'x_Observacion', 'Observacion', '`Observacion`', '`Observacion`', 200, 22, -1, false, '`Observacion`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Lugar
        $this->Lugar = new DbField('impresiones2', 'impresiones2', 'x_Lugar', 'Lugar', '`Lugar`', '`Lugar`', 200, 20, -1, false, '`Lugar`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Fecha
        $this->Fecha = new DbField('impresiones2', 'impresiones2', 'x_Fecha', 'Fecha', '`Fecha`', CastDateFieldForLike("`Fecha`", 0, "DB"), 133, 10, 0, false, '`Fecha`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Cedula
        $this->Cedula = new DbField('impresiones2', 'impresiones2', 'x_Cedula', 'Cedula', '`Cedula`', '`Cedula`', 200, 30, -1, false, '`Cedula`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // NIT
        $this->NIT = new DbField('impresiones2', 'impresiones2', 'x_NIT', 'NIT', '`NIT`', '`NIT`', 200, 30, -1, false, '`NIT`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Direccion
        $this->Direccion = new DbField('impresiones2', 'impresiones2', 'x_Direccion', 'Direccion', '`Direccion`', '`Direccion`', 200, 255, -1, false, '`Direccion`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Monto
        $this->Monto = new DbField('impresiones2', 'impresiones2', 'x_Monto', 'Monto', '`Monto`', '`Monto`', 131, 7, -1, false, '`Monto`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`impresiones2`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("impresiones2list");
    }
    ...
    {
        global $Language;
        if ($pageName == "impresiones2view") {
            return $Language->phrase("View");
        } elseif ($pageName == "impresiones2edit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "impresiones2add") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "Impresiones2View";
            case Config("API_ADD_ACTION"):
                return "Impresiones2Add";
            case Config("API_EDIT_ACTION"):
                return "Impresiones2Edit";
            case Config("API_DELETE_ACTION"):
                return "Impresiones2Delete";
            case Config("API_LIST_ACTION"):
                return "Impresiones2List";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("impresiones2view", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("impresiones2view", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "impresiones2add?" . $this->getUrlParm($parm);
        } else {
            $url = "impresiones2add";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("impresiones2edit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("impresiones2add", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("impresiones2delete", $this->getUrlParm());
    }
...
SORTHTML;
    ...
    public function renderEditRow()
    {
        ...
        if (!$this->MotivoBaja->Raw) {
            $this->MotivoBaja->CurrentValue = HtmlDecode($this->MotivoBaja->CurrentValue);
        }
        $this->MotivoBaja->EditValue = $this->MotivoBaja->CurrentValue;
