 ...
 * Page class
 */
class Impresiones2List extends Impresiones2
{
    use MessagesTrait;
    ...
    // Table name
    public $TableName = 'impresiones2';

    // Page object name
    public $PageObjName = "Impresiones2List";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "fimpresiones2list";
    ...
    public function __construct()
    {
        ...
        // Table object (impresiones2)
        if (!isset($GLOBALS["impresiones2"]) || get_class($GLOBALS["impresiones2"]) == PROJECT_NAMESPACE . "impresiones2") {
            $GLOBALS["impresiones2"] = &$this;
        }
        ...
        $this->AddUrl = "impresiones2add";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "impresiones2delete";
        $this->MultiUpdateUrl = "impresiones2update";

        // Table name (for backward compatibility only)
        if (!defined(PROJECT_NAMESPACE . "TABLE_NAME")) {
            define(PROJECT_NAMESPACE . "TABLE_NAME", 'impresiones2');
        }
        ...
        $this->FilterOptions->TagClassName = "ew-filter-option fimpresiones2listsrch";
    ...
    public function terminate($url = "")
    {
        ...
        if ($this->CustomExport && $this->CustomExport == $this->Export && array_key_exists($this->CustomExport, Config("EXPORT_CLASSES"))) {
            ...
            if (class_exists($class)) {
                $doc = new $class(Container("impresiones2"));
                $doc->Text = @$content;
    ...
    public $PageSizes = "100,200,-1"; // Page sizes (comma separated)
    ...
    public function getFilterList()
    {
        ...
        $filterList = "";
        $savedFilterList = "";
        $filterList = Concat($filterList, $this->CodContrato->AdvancedSearch->toJson(), ","); // Field CodContrato
        $filterList = Concat($filterList, $this->Sigla->AdvancedSearch->toJson(), ","); // Field Sigla
        $filterList = Concat($filterList, $this->Vencimiento->AdvancedSearch->toJson(), ","); // Field Vencimiento
        $filterList = Concat($filterList, $this->CodigoInterno->AdvancedSearch->toJson(), ","); // Field CodigoInterno
        $filterList = Concat($filterList, $this->RazonSocial->AdvancedSearch->toJson(), ","); // Field RazonSocial
        $filterList = Concat($filterList, $this->Propietario->AdvancedSearch->toJson(), ","); // Field Propietario
        $filterList = Concat($filterList, $this->MotivoBaja->AdvancedSearch->toJson(), ","); // Field MotivoBaja
        $filterList = Concat($filterList, $this->DiasVcto->AdvancedSearch->toJson(), ","); // Field DiasVcto
        ...
        $filterList = Concat($filterList, $this->NIT->AdvancedSearch->toJson(), ","); // Field NIT
    ...
    protected function processFilterList()
    {
        ...
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            $UserProfile->setSearchFilters(CurrentUserName(), "fimpresiones2listsrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field CodContrato
        $this->CodContrato->AdvancedSearch->SearchValue = @$filter["x_CodContrato"];
        $this->CodContrato->AdvancedSearch->SearchOperator = @$filter["z_CodContrato"];
        $this->CodContrato->AdvancedSearch->SearchCondition = @$filter["v_CodContrato"];
        $this->CodContrato->AdvancedSearch->SearchValue2 = @$filter["y_CodContrato"];
        $this->CodContrato->AdvancedSearch->SearchOperator2 = @$filter["w_CodContrato"];
        $this->CodContrato->AdvancedSearch->save();
        ...
        // Field Vencimiento
        $this->Vencimiento->AdvancedSearch->SearchValue = @$filter["x_Vencimiento"];
        $this->Vencimiento->AdvancedSearch->SearchOperator = @$filter["z_Vencimiento"];
        $this->Vencimiento->AdvancedSearch->SearchCondition = @$filter["v_Vencimiento"];
        $this->Vencimiento->AdvancedSearch->SearchValue2 = @$filter["y_Vencimiento"];
        $this->Vencimiento->AdvancedSearch->SearchOperator2 = @$filter["w_Vencimiento"];
        $this->Vencimiento->AdvancedSearch->save();

        // Field CodigoInterno
        $this->CodigoInterno->AdvancedSearch->SearchValue = @$filter["x_CodigoInterno"];
        $this->CodigoInterno->AdvancedSearch->SearchOperator = @$filter["z_CodigoInterno"];
        $this->CodigoInterno->AdvancedSearch->SearchCondition = @$filter["v_CodigoInterno"];
        $this->CodigoInterno->AdvancedSearch->SearchValue2 = @$filter["y_CodigoInterno"];
        $this->CodigoInterno->AdvancedSearch->SearchOperator2 = @$filter["w_CodigoInterno"];
        $this->CodigoInterno->AdvancedSearch->save();
        ...
        // Field MotivoBaja
        $this->MotivoBaja->AdvancedSearch->SearchValue = @$filter["x_MotivoBaja"];
        $this->MotivoBaja->AdvancedSearch->SearchOperator = @$filter["z_MotivoBaja"];
        $this->MotivoBaja->AdvancedSearch->SearchCondition = @$filter["v_MotivoBaja"];
        $this->MotivoBaja->AdvancedSearch->SearchValue2 = @$filter["y_MotivoBaja"];
        $this->MotivoBaja->AdvancedSearch->SearchOperator2 = @$filter["w_MotivoBaja"];
        $this->MotivoBaja->AdvancedSearch->save();

        // Field DiasVcto
        $this->DiasVcto->AdvancedSearch->SearchValue = @$filter["x_DiasVcto"];
        $this->DiasVcto->AdvancedSearch->SearchOperator = @$filter["z_DiasVcto"];
        $this->DiasVcto->AdvancedSearch->SearchCondition = @$filter["v_DiasVcto"];
        $this->DiasVcto->AdvancedSearch->SearchValue2 = @$filter["y_DiasVcto"];
        $this->DiasVcto->AdvancedSearch->SearchOperator2 = @$filter["w_DiasVcto"];
        $this->DiasVcto->AdvancedSearch->save();
    ...
    {
        $where = "";
        $this->buildBasicSearchSql($where, $this->Sigla, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->CodigoInterno, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->RazonSocial, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->Propietario, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->MotivoBaja, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->Observacion, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->Lugar, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->Cedula, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->NIT, $arKeywords, $type);
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->CodContrato); // CodContrato
            $this->updateSort($this->Sigla); // Sigla
            $this->updateSort($this->Vencimiento); // Vencimiento
            $this->updateSort($this->CodigoInterno); // CodigoInterno
            $this->updateSort($this->RazonSocial); // RazonSocial
            $this->updateSort($this->Propietario); // Propietario
            $this->updateSort($this->MotivoBaja); // MotivoBaja
            $this->updateSort($this->DiasVcto); // DiasVcto
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                $orderBy = "";
                $this->setSessionOrderBy($orderBy);
                $this->CodContrato->setSort("");
                $this->Sigla->setSort("");
                $this->Vencimiento->setSort("");
                $this->CodigoInterno->setSort("");
                $this->RazonSocial->setSort("");
                $this->Propietario->setSort("");
                $this->MotivoBaja->setSort("");
                $this->DiasVcto->setSort("");
    ...
    public function renderListOptions()
    {
        ...
        $opt->Body = "<div class=\"custom-control custom-checkbox d-inline-block\"><input type=\"checkbox\" id=\"key_m_" . $this->RowCount . "\" name=\"key_m[]\" class=\"custom-control-input ew-multi-select\" value=\"" . HtmlEncode($this->CodContrato->CurrentValue) . "\" onclick=\"ew.clickMultiCheckbox(event);\"><label class=\"custom-control-label\" for=\"key_m_" . $this->RowCount . "\"></label></div>";
    ...
    protected function setupOtherOptions()
    {
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fimpresiones2listsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fimpresiones2listsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<a class="ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" href="#" onclick="return ew.submitAction(event,jQuery.extend({f:document.fimpresiones2list},' . $listaction->toJson(true) . '));">' . $icon . '</a>';
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            // MotivoBaja
            $this->MotivoBaja->ViewValue = $this->MotivoBaja->CurrentValue;
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"return ew.export(document.fimpresiones2list, '" . $this->ExportExcelUrl . "', 'excel', true);\">" . $Language->phrase("ExportToExcel") . "</a>";
            } else {
                return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
            }
        } elseif (SameText($type, "word")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"return ew.export(document.fimpresiones2list, '" . $this->ExportWordUrl . "', 'word', true);\">" . $Language->phrase("ExportToWord") . "</a>";
            } else {
                return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
            }
        } elseif (SameText($type, "pdf")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"return ew.export(document.fimpresiones2list, '" . $this->ExportPdfUrl . "', 'pdf', true);\">" . $Language->phrase("ExportToPDF") . "</a>";
            } else {
            ...
            return '<button id="emf_impresiones2" class="ew-export-link ew-email" title="' . $Language->phrase("ExportToEmailText") . '" data-caption="' . $Language->phrase("ExportToEmailText") . '" onclick="ew.emailDialogShow({lnk:\'emf_impresiones2\', hdr:ew.language.phrase(\'ExportToEmailText\'), f:document.fimpresiones2list, sel:false' . $url . '});">' . $Language->phrase("ExportToEmail") . '</button>';
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fimpresiones2listsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
