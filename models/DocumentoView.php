 ...
 * Page class
 */
class DocumentoView extends Documento
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DocumentoView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("CodDocumento") ?? Route("CodDocumento")) !== null) {
            $this->RecKey["CodDocumento"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("CodDocumento") ?? Route("CodDocumento")) !== null) {
                ...
                $this->RecKey["CodDocumento"] = $this->CodDocumento->QueryStringValue;
            } elseif (Post("CodDocumento") !== null) {
                $this->CodDocumento->setFormValue(Post("CodDocumento"));
                $this->RecKey["CodDocumento"] = $this->CodDocumento->FormValue;
            } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
                $this->CodDocumento->setQueryStringValue($keyValue);
                $this->RecKey["CodDocumento"] = $this->CodDocumento->QueryStringValue;
            } else {
                $returnUrl = "documentolist"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "documentolist"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "documentolist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
