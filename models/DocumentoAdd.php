 ...
 * Page class
 */
class DocumentoAdd extends Documento
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DocumentoAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "documentoview") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->CodDocumento->OldValue = $this->CodDocumento->CurrentValue;
    ...
    protected function newRow()
    {
        ...
        $row = [];
        $row['CodDocumento'] = $this->CodDocumento->CurrentValue;
    ...
    protected function addRow($rsold = null)
    {
        ...
        // Gestion
        $this->Gestion->setDbValueDef($rsnew, $this->Gestion->CurrentValue, 0, false);
