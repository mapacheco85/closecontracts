...
/**
 * Table class for proveedor2
 */
class Proveedor2 extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'proveedor2';
        $this->TableName = 'proveedor2';
        $this->TableType = 'LINKTABLE';

        // Update Table
        $this->UpdateTable = "`proveedor`";
        $this->Dbid = 'mpacontract1';
        ...
        // CodProveedor
        $this->CodProveedor = new DbField('proveedor2', 'proveedor2', 'x_CodProveedor', 'CodProveedor', '`CodProveedor`', '`CodProveedor`', 3, 11, -1, false, '`CodProveedor`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // RazonSocial
        $this->RazonSocial = new DbField('proveedor2', 'proveedor2', 'x_RazonSocial', 'RazonSocial', '`RazonSocial`', '`RazonSocial`', 200, 20, -1, false, '`RazonSocial`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Propietario
        $this->Propietario = new DbField('proveedor2', 'proveedor2', 'x_Propietario', 'Propietario', '`Propietario`', '`Propietario`', 200, 20, -1, false, '`Propietario`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // NIT
        $this->NIT = new DbField('proveedor2', 'proveedor2', 'x_NIT', 'NIT', '`NIT`', '`NIT`', 200, 20, -1, false, '`NIT`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Cedula
        $this->Cedula = new DbField('proveedor2', 'proveedor2', 'x_Cedula', 'Cedula', '`Cedula`', '`Cedula`', 200, 20, -1, false, '`Cedula`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Telefono
        $this->Telefono = new DbField('proveedor2', 'proveedor2', 'x_Telefono', 'Telefono', '`Telefono`', '`Telefono`', 200, 20, -1, false, '`Telefono`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Direccion
        $this->Direccion = new DbField('proveedor2', 'proveedor2', 'x_Direccion', 'Direccion', '`Direccion`', '`Direccion`', 200, 20, -1, false, '`Direccion`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CodRegion
        $this->CodRegion = new DbField('proveedor2', 'proveedor2', 'x_CodRegion', 'CodRegion', '`CodRegion`', '`CodRegion`', 3, 11, -1, false, '`CodRegion`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Vigente
        $this->Vigente = new DbField('proveedor2', 'proveedor2', 'x_Vigente', 'Vigente', '`Vigente`', '`Vigente`', 3, 1, -1, false, '`Vigente`', false, false, false, 'FORMATTED TEXT', 'CHECKBOX');
        ...
        switch ($CurrentLanguage) {
            case "en":
                $this->Vigente->Lookup = new Lookup('Vigente', 'proveedor2', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->Vigente->Lookup = new Lookup('Vigente', 'proveedor2', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("proveedor2list");
    }
    ...
    {
        global $Language;
        if ($pageName == "proveedor2view") {
            return $Language->phrase("View");
        } elseif ($pageName == "proveedor2edit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "proveedor2add") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "Proveedor2View";
            case Config("API_ADD_ACTION"):
                return "Proveedor2Add";
            case Config("API_EDIT_ACTION"):
                return "Proveedor2Edit";
            case Config("API_DELETE_ACTION"):
                return "Proveedor2Delete";
            case Config("API_LIST_ACTION"):
                return "Proveedor2List";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("proveedor2view", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("proveedor2view", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "proveedor2add?" . $this->getUrlParm($parm);
        } else {
            $url = "proveedor2add";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("proveedor2edit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("proveedor2add", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("proveedor2delete", $this->getUrlParm());
    }
...
SORTHTML;
    ...
    public function renderListRow()
    {
        ...
        $this->CodRegion->ViewValue = FormatNumber($this->CodRegion->ViewValue, 0, -2, -2, -2);
    ...
    public function renderEditRow()
    {
        ...
        $this->CodRegion->EditValue = $this->CodRegion->CurrentValue;
