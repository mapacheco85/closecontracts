...
class ServicioSearch extends Servicio
{
    ...
    // Page object name
    public $PageObjName = "ServicioSearch";
    ...
    protected function buildAdvancedSearch()
    {
        ...
        $this->buildSearchUrl($srchUrl, $this->Nombre); // Nombre
        if ($srchUrl != "") {
            $srchUrl .= "&";
        }
        $srchUrl .= "cmd=search";
    ...
    protected function loadSearchValues()
    {
        ...
        if ($this->Sigla->AdvancedSearch->post()) {
            $hasValue = true;
        }
        if ($this->Nombre->AdvancedSearch->post()) {
            $hasValue = true;
        }
        return $hasValue;
    }
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->CodServicio->EditValue = HtmlEncode($this->CodServicio->AdvancedSearch->SearchValue);
    ...
    protected function validateSearch()
    {
        ...
        if (!CheckInteger($this->CodServicio->AdvancedSearch->SearchValue)) {
            $this->CodServicio->addErrorMessage($this->CodServicio->getErrorMessage(false));
        }
