...
return [
    ...
    "documento" => \DI\create(Documento::class),
    "proveedor" => \DI\create(Proveedor::class),
    "region" => \DI\create(Region::class),
    "servicio" => \DI\create(Servicio::class),
    "vencimientos" => \DI\create(Vencimientos::class),
    "resumen" => \DI\create(Resumen::class),
    "impresiones" => \DI\create(Impresiones::class),
    "codigosinternos" => \DI\create(Codigosinternos::class),
    "impresiones2" => \DI\create(Impresiones2::class),
];
