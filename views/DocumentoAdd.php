...
loadjs.ready("head", function () {
    ...
    fdocumentoadd = currentForm = new ew.Form("fdocumentoadd", "add");
    ...
    // Form_CustomValidate
    fdocumentoadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fdocumentoadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fdocumentoadd.lists.CodServicio = <?= $Page->CodServicio->toClientList($Page) ?>;
    loadjs.done("fdocumentoadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fdocumentoadd" id="fdocumentoadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
