...
loadjs.ready("head", function () {
    ...
    fregionadd = currentForm = new ew.Form("fregionadd", "add");
    ...
    // Form_CustomValidate
    fregionadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fregionadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fregionadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fregionadd" id="fregionadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<input type="hidden" data-table="region" data-field="x_Sigla" data-hidden="1" name="x_Sigla" id="x_Sigla" value="<?= HtmlEncode($Page->Sigla->FormValue) ?>">
<?php } ?>
</div></div>
    </div>
<?php } ?>
...
<input type="hidden" data-table="region" data-field="x_Descripcion" data-hidden="1" name="x_Descripcion" id="x_Descripcion" value="<?= HtmlEncode($Page->Descripcion->FormValue) ?>">
<?php } ?>
</div></div>
    </div>
<?php } ?>
