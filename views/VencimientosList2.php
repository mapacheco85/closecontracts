...
<?php if ($Page->Lugar->Visible) { // Lugar ?>
        <th data-name="Lugar" class="<?= $Page->Lugar->headerCellClass() ?>"><div id="elh_vencimientos_Lugar" class="vencimientos_Lugar"><?= $Page->renderSort($Page->Lugar) ?></div></th>
<?php } ?>
<?php if ($Page->Fecha->Visible) { // Fecha ?>
        <th data-name="Fecha" class="<?= $Page->Fecha->headerCellClass() ?>"><div id="elh_vencimientos_Fecha" class="vencimientos_Fecha"><?= $Page->renderSort($Page->Fecha) ?></div></th>
<?php } ?>
<?php if ($Page->Cedula->Visible) { // Cedula ?>
        <th data-name="Cedula" class="<?= $Page->Cedula->headerCellClass() ?>"><div id="elh_vencimientos_Cedula" class="vencimientos_Cedula"><?= $Page->renderSort($Page->Cedula) ?></div></th>
<?php } ?>
<?php if ($Page->NIT->Visible) { // NIT ?>
        <th data-name="NIT" class="<?= $Page->NIT->headerCellClass() ?>"><div id="elh_vencimientos_NIT" class="vencimientos_NIT"><?= $Page->renderSort($Page->NIT) ?></div></th>
<?php } ?>
<?php if ($Page->Direccion->Visible) { // Direccion ?>
        <th data-name="Direccion" class="<?= $Page->Direccion->headerCellClass() ?>"><div id="elh_vencimientos_Direccion" class="vencimientos_Direccion"><?= $Page->renderSort($Page->Direccion) ?></div></th>
<?php } ?>
<?php if ($Page->Monto->Visible) { // Monto ?>
        <th data-name="Monto" class="<?= $Page->Monto->headerCellClass() ?>"><div id="elh_vencimientos_Monto" class="vencimientos_Monto"><?= $Page->renderSort($Page->Monto) ?></div></th>
<?php } ?>
<?php
...
<span id="el<?= $Page->RowCount ?>_vencimientos_Lugar">
...
<span id="el<?= $Page->RowCount ?>_vencimientos_Fecha">
...
<span id="el<?= $Page->RowCount ?>_vencimientos_Cedula">
...
<span id="el<?= $Page->RowCount ?>_vencimientos_NIT">
...
<span id="el<?= $Page->RowCount ?>_vencimientos_Direccion">
...
<span id="el<?= $Page->RowCount ?>_vencimientos_Monto">
